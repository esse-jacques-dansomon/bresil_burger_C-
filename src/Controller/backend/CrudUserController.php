...
class CrudUserController extends AbstractController
{
    ...
    {
        return $this->render('backend/pages/crud_user/index.html.twig', [
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('backend/pages/crud_user/new.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('backend/pages/crud_user/show.html.twig', [
            'user' => $user,
        ]);
    }
    ...
    public function edit(Request $request, User $user, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->renderForm('backend/pages/crud_user/edit.html.twig', [
            'user' => $user,
            'form' => $form,
        ]);
    }
